...
- remaining engineering evidence: direct manipulation/rotation incomplete (MS-038); refinement controls require coherent redesign later (MS-041)
...
- current:
  7. E4 P1 remaining: implement MS-038 direct model manipulation and visible rotation-ring interaction while retaining precise axis constraints and existing Core transform authority.
- queued:
  8. E5: integrate/regress v1.0.32 checkpoint and return to Coordinator review; MS-041 Refinement/Kitbash implementation waits until E1-E4 correctness, with exact UI details reversible pending user design approval.
