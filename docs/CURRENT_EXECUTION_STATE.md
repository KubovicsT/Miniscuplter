...
- current: UI-neutral attachment authority convergence
- next:
  1. complete attachment authority convergence without changing unresolved user-facing interaction design
  2. establish revision-bound Refinement candidate/dependency foundations that preserve Core identity, transaction and stale-result authority
