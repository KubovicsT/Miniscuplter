...
- next:
  1. finish the latest exact-head full build/package validation; if green, continue the remaining revision-safe Refinement terminal/persistence edge cases as one related slice
