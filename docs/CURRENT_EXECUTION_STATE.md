...
### Ordered Dev queue
1. 2D detail endpoint contract — P1 deterministic runtime regression
...
4. 3D render / transform / navigation correctness — P1
...
5. Project/settings/prompt UX continuity — P1/P2
...
6. Close the corrective checkpoint
